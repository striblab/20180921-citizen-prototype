...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20180921-citizen-prototype">Loading...</div>
...
1.  Create an LCD that is connected to the Article.
    ...
    * Common values in the LCD to use:
      ...
      * `styles`: `news/projects/all/20180921-citizen-prototype/styles.bundle.css`
      * `scripts`: `news/projects/all/20180921-citizen-prototype/app.bundle.js`
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20180921-citizen-prototype/",
      "url": "http://static.startribune.com/news/projects-staging/all/20180921-citizen-prototype/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20180921-citizen-prototype/",
      "url": "http://static.startribune.com/news/projects/all/20180921-citizen-prototype/"
    }
  }
}
```
